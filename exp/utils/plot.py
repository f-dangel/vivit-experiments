"""Plotting functionality for experiments."""
...
"""
    ...
    def _remove_linewidths(lines):
        ...
        linewidths = [
            ...
            r"ultra thin",
            r"thin",
            # use \includegraphics command instead of \pgfimage,
            # it allows specifying the figure path via \graphicspath
            r"includegraphics cmd=\pgfimage",
        ]
        new_lines = []
        for line in lines:
    ...
    def _remove_some_arguments(lines):
        ...
        to_remove = [
            ...
            # "ymode",
            r"log basis y",
            r"scaled minor x ticks",
            r"scaled minor y ticks",
        ]
