...
`plot_eigspace_vivit_vs_mb.py` for all configurations. It creates one job for each 
configuration. The switch `SLRUM` allows `plot_eigspace_vivit_vs_mb.py` to be executed 
...
if __name__ == "__main__":
    for config in CONFIGURATIONS:
        ...
        if SLURM:
            SJ = SlurmJob(
                job_name="run_plot_eigspace_vivit_vs_mb",
                job_path=job_path,
                gpu="gpu-v100",
                time="3-00:00:00",
                memory="32G",
