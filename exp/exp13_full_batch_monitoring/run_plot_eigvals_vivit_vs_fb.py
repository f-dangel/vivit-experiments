...
`plot_eigvals_vivit_vs_fb.py` for all configurations. It creates one job for each 
configuration. The switch `SLRUM` allows `plot_eigvals_vivit_vs_fb.py` to be executed 
...
if __name__ == "__main__":
    for config in CONFIGURATIONS:
        ...
        if SLURM:
            SJ = SlurmJob(
                job_name="run_plot_eigvals_vivit_vs_fb",
                job_path=job_path,
                gpu="gpu-v100",
                time="3-00:00:00",
                memory="32G",
